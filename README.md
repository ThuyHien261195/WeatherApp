...
- Liskov subtitution principle: **BaseResponse** and **SearchResponse** is extended has also **code** and **message** field.
...
![alt text](https://i.ibb.co/wzRtpfj/Screenshot-2021-07-18-at-4-37-46-PM.png)
